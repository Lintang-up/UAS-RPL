...
<head>
  ...
  <title> Data <?php echo $username;?> :: Sekull </title>
  <style>
    .logo{
      width: 80px;
      height: 80px;
...
<body>
  ...
  <div class="form_class">
    <h1> Data <?php echo $username;?></h1> <br>
    <table class="table1">   
    <?php
    ...
    <table class="table1">
       ...
       while ($data = mysqli_fetch_array($query)) {    ?>
			<tr>
        <td> Dokumen Akte</td>
				<td> <img class="pl" src="<?php echo "files/".$data['Akte']; ?>"> </td>		
			</tr>
			<tr>
        <td> Dokumen KK</td>
				<td> <img class="pl" src="<?php echo "files/".$data['KK']; ?>"> </td>		
			</tr>
			<tr>
        <td> PasFoto</td>
				<td> <img class="pl" src="<?php echo "files/".$data['PasFoto']; ?>">	</td>		
			</tr>
			<?php } ?>
		</table>
  </div>
